  ...
  return (
    <div className="w-full bg-black">
      <section id="features" className="py-12 bg-black w-4/5 mx-auto">
        <h3 className="text-3xl text-center font-semibold mb-6 text-white">Equipe</h3>
        <div className="flex flex-col md:flex-row flex-wrap gap-6 justify-center">
          {equipe.map((membre, index) => (
            <motion.div
              key={membre.id}
              className="blue p-6 shadow rounded-lg text-black w-full sm:w-72 md:w-60 lg:w-72 flex flex-col items-center"
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-2 text-center text-white">{membre.name}</h4>
              <p className="text-center text-sm mb-4 text-white">{membre.description}</p>
