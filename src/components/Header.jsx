...
const Header = () => (
  <header className="sticky top-0 w-full bg-black shadow z-20 rounded-l-2xl rounded-r-2xl my-8">
    <div className="flex justify-between items-center p-4 rounded-bl-2xl rounded-br-2xl">
